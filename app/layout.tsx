    ...
    <html lang="en">
      ...
      >
        ...
        >
          ...
          <span className="absolute right-full mr-3 bg-white text-green-600 px-2 py-1 rounded text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap shadow-md">
            Chat with us
          </span>
        </a>
      </body>
