...
const UoTitle = () => {
  ...
  return (
    <div className="relative flex max-w-6xl justify-center flex-col h-full items-center mx-auto rounded-md shadow-md w-full bg-[url('/upes.png')] bg-center bg-no-repeat bg-cover">
