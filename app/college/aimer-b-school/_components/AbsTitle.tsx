...
const AbsTitle = () => {
  const universityInfo = [
    {
      title: "Aimer B School",
      rating: 4.8,
      description:
        "AIMER: A Practical Business Education Campus Offering the Best MBA Programs in Markaz Knowledge City, a Sprawling 15-Acre Township that Blends Business, Leisure, and Health.",
      email: "info@aimerbschool.com",
      phone: "9778413288",
      logos: [
        {
          name: "Facebook",
          icon: <Facebook size={20} />,
          link: "https://www.facebook.com/aimerbschoolcalicut",
        },
        {
          name: "Linkedin",
          icon: <Linkedin size={20} />,
          link: "https://www.linkedin.com/company/aimer-avaan-institute-of-management-education-and-research",
        },
        {
          name: "Instagram",
          icon: <Instagram size={20} />,
          link: "https://www.instagram.com/aimerbschool/",
        },
        {
          name: "Youtube",
          icon: <Youtube size={20} />,
          link: "https://www.youtube.com/@aimerbschool5085",
        },
      ],
    },
  ];
  return (
    <div className="relative flex max-w-6xl justify-center flex-col h-full items-center mx-auto rounded-md shadow-md w-full bg-[url('/aimerbschool.png')] bg-center bg-no-repeat bg-cover">
      ...
      <div className="flex flex-col lg:flex-row gap-5 justify-center lg:justify-between items-center w-full px-8 py-8 relative z-10">
        <div className="">
          <img src="/aimer-logo.png" alt="UPES Logo" className="h-50 w-auto" />
        </div>
